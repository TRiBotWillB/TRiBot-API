...
public enum TeleportMethod implements Validatable {
    ...
    KOUREND_POH_TELEPORT(TeleportConstants.LEVEL_20_WILDERNESS_LIMIT, KOUREND_POH),
    ...
    public boolean canUse() {
        ...
        switch (this) {
            ...
            case KOUREND_TELEPORT:
                return Spell.KOUREND_TELEPORT.canUse();
            case KOUREND_POH_TELEPORT:
                return Inventory.getCount("Kourend teleport") > 0;
            case GLORY:
